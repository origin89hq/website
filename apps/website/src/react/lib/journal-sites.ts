...
export const journalSites = [
  {
    ...
    lead: "Solar from one brand. Batteries from another. A generator that’s been there for years.",
    ...
    proofTitle: "A useful answer, with the readings behind it.",
    proof:
  ...
  },
  {
    ...
    lead: "Generators, pumps, fuel tanks and sensors. Different equipment, spread across a working site.",
    body: "Bring supported site utilities into one view. See which readings need attention and give the next service visit a clearer starting point.",
    note: "Controller and app in development.",
  ...
  },
  {
    ...
    lead: "A telecom shelter in Nunavut. Backup power, batteries and temperature sensors from different makers.",
    body: "Keep the site’s essentials in view. Understand the last reported conditions, see when data has stopped arriving and plan the next check with better context.",
    note: "Controller and app in development.",
    equipment: ["Backup power & batteries", "Shelter temperature", "Connection & alarms"],
    appTitle: ["Know what’s current.", "Know what isn’t."],
    appBody:
      "Buddy makes missing updates visible. The last battery or shelter reading stays useful, with its age attached and the current condition clearly marked unknown.",
