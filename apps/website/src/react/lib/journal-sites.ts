...
export const journalSites = [
  {
    ...
    alt: "A cottage at night with lit windows, a solar rack, a woodshed generator and a propane tank, linked by lit signal paths",
  ...
  },
  {
    ...
    alt: "A mine utility at night: a Quonset building, a genset container, a tank and a battery skid, linked by lit signal paths",
    caption: "Power, fuel and tanks at a remote mine.",
  ...
  },
  {
    ...
    alt: "A telecom shelter at night with a lattice tower, a genset and a fuel tank, linked by lit signal paths",
